...
Vytočení telefonního čísla (tel:555-0199), poslání textové zprávy (sms:555-0199), email (mailto:support@orgzly.com) nebo webová stránky ([[https://orgzly.alensiljak.cc][Orgzly II]).

Linkovat lze i ostatní poznámky nebo sešity v rámci aplikace.

Navštivte [[https://orgzly.alensiljak.cc/docs#links]] pro více informací.
...
Navšivte [[https://orgzly.alensiljak.cc/docs#search]] pro další podrobnosti.
