...
Wybierz numer telefonu (tel:123-456-789), wyślij wiadomość SMS (sms:123-456-789), napisz e-mail (mailto:support@orgzly.com) lub odwiedź stronę internetową ([[https://orgzly.alensiljak.cc][Orgzly II]).

Możesz również zamieszczać łącza do innych notatek lub notatników w aplikacji.

Zobacz [[https://orgzly.alensiljak.cc/docs#links]] aby uzyskać więcej informacji.
...
Zobacz [[https://orgzly.alensiljak.cc/docs#search]] aby dowiedzieć się więcej.
