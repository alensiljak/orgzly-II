...
Wählen Sie eine Telefonnummer (tel:555-0199), senden Sie SMS (sms:555-0199), schreiben Sie eine E-Mail (mailto:support@orgzly.com) oder besuchen Sie eine Webseite ([[https://orgzly.alensiljak.cc][Orgzly II]).

Sie können auch auf eine andere Notiz oder ein anderes Notizbuch innerhalb der App verweisen.

Siehe [[https://orgzly.alensiljak.cc/docs#links]] für weitere Informationen.
...
Besuchen Sie [[https://orgzly.alensiljak.cc/docs#search]], um mehr zu erfahren.
