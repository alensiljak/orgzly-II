...
Ligar para um número (tel:555-0199), enviar SMS (sms:555-0199), enviar emails (mailto:support@orgzly.com) ou acessar uma página da web ([[https://orgzly.alensiljak.cc][Orgzly II]).

Você também pode criar um link para outra nota ou bloco de notas dentro do aplicativo.

Acesse [[https://orgzly.alensiljak.cc/docs#links]] para mais informações (conteúdo em inglês).
...
Acesse [[https://orgzly.alensiljak.cc/docs#search]] para saber mais (em inglês).
