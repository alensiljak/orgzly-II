...
電話をかける (tel:555-0199), SMS送信 (sms:555-0199), メール編集 (mailto:support@orgzly.com) Webページを開く ([[https://orgzly.alensiljak.cc][Orgzly II]).

アプリ内の、別のメモやメモ帳にも、リンクができます。

詳しくは https://orgzly.alensiljak.cc/docs#links を見てください。
...
詳しくは [[https://orgzly.alensiljak.cc/docs#search]] を見てください。
