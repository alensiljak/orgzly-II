...
Composer un numéro de téléphone (tel:555-0199), envoyer un SMS (sms:555-0199), écrire un courriel (mailto:support@orgzly.com) ou aller à une page web ([[https://www.orgzly.com][Orgzly.com]]).

Vous pouvez également lier une autre note ou un autre bloc-note de l'application.

Voir [[https://www.orgzly.com/docs#links]] pour de plus amples informations (en anglais).
...
Voir [[https://www.orgzly.com/docs#search]] pour en savoir plus.
