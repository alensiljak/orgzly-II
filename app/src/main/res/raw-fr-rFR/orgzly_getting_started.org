...
*** Il n’y a pas de limite au nombre de niveaux que vous pouvez créer
...
*** Une note avec la balise =ARCHIVE= est grisée :ARCHIVE:
...
*** DONE Ceci est une note avec un état de type /fait/
CLOSED: [2018-01-24 Mer 17:00]

** Les notes parents peuvent suivre l'état des notes enfants [1/3] [33%]

*** TODO Pour suivre la proportion d'éléments avec TODO ou DONE, ajouter [/] dans le titre de la note

*** TODO Pour suivre le pourcentage d'éléments avec TODO ou DONE, ajouter [%] dans le titre de la note

*** DONE Les deux peuvent être utilisés ensemble
CLOSED: [2025-03-13 Thu 08:37]

L'ordre n'a pas d'importance et les compteurs se mettront à jour automatiquement.
...
** Les dates d'événements peuvent être utilisées n'importe où dans le contenu de la note

Il peut y avoir plusieurs dates d'événements :

- <2015-02-20 Fri>
- <2015-02-21 Sat>

** Il est possible de mettre des rappels pour les dates planifiées, d'échéance ou d'événements

Ils sont désactivés par défaut et doivent être activés dans les paramètres.

** [#A] Les notes peuvent avoir une priorité

Vous pouvez modifier le nombre de priorités dans les paramètres. Vous pouvez également changer la priorité par défaut - la priorité appliquée lorsqu'elle n'est pas définie.

** Les notes peuvent inclure des liens

Composer un numéro de téléphone (tel:555-0199), envoyer un SMS (sms:555-0199), écrire un courriel (mailto:support@orgzly.com) ou aller à une page web ([[https://orgzly.alensiljak.cc][Orgzly II]).

Vous pouvez également lier une autre note ou un autre bloc-note de l'application.

Voir [[https://orgzly.alensiljak.cc/docs#links]] pour de plus amples informations (en anglais).
...
** Vous pouvez créer des liste de cases à cocher
...
** On peut aussi suivre l'état des cases à cocher depuis le titre de la note [66%] [2/3]
...
Voir [[https://orgzly.alensiljak.cc/docs#search]] pour en savoir plus.
