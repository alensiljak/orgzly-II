...
Pokličite telefonsko številko (tel:555-0199), pošljite SMS (sms:555-0199), sestavite e-pošto (mailto:support@orgzly.com) ali obiščite spletno stran ([[https://orgzly.alensiljak.cc][Orgzly II]).

V aplikaciji se lahko povežete tudi z drugim opombo ali zvezkom.

Za več informacij glejte [[https://orgzly.alensiljak.cc/docs#links]].
...
Za več informacij glejte [[https://orgzly.alensiljak.cc/docs#search]].
