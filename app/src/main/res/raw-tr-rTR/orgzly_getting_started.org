...
Bir telefon numarası çevirin (tel:555-0199), SMS gönderin (sms:555-0199), e-posta oluşturun (mailto:support@orgzly.com) veya bir web sayfasını ziyaret edin ([[http://orgzly.alensiljak.cc][Orgzly II]).

Ayrıca uygulama içindeki başka bir nota veya deftere bağlantı verilebilir.

Daha fazla bilgi için [[http://orgzly.alensiljak.cc/docs#links]] adresine bakın.
...
Daha fazla bilgi edinmek için [[http://orgzly.alensiljak.cc/docs#search]] adresine göz at.
