...
Marcar un número de teléfono (tel:555-0199), enviar SMS (sms:555-0199), componer un correo electrónico (mailto:support@orgzly.com) o visitar una página web ([[https://orgzly.alensiljak.cc][Orgzly II]).

También puede enlazar a otra nota o libreta dentro de la aplicación.

Consulte [[https://orgzly.alensiljak.cc/docs#links]] para obtener más información.
...
Visite [[https://orgzly.alensiljak.cc/docs#search]] para aprender más.
