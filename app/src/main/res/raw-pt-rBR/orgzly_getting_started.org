...
Discar um número de telefone (tel:555-0199), enviar SMS (sms:555-0199), escrever e-mail (mailto:support@orgzly.com) ou visitar uma página da web ([[https://orgzly.alensiljak.cc][Orgzly II]).

Você também pode criar links para uma outra nota ou caderno dentro do app.

Consulte [[https://orgzly.alensiljak.cc/docs#links]] para obter mais informações.
...
Acesse [[https://orgzly.alensiljak.cc/docs#search]] para aprender mais.
