...
전화 걸기 (tel:555-0199), 문자 보내기 (sms:555-0199), 이메일 발송 (mailto:support@orgzly.com), 인터넷 연결 ([[https://www.orgzly.com][Orgzly.com]]).

앱 내의 다른 메모나 메모장도 바로 가기를 사용할 수 있습니다.

자세한 내용은 [[https://www.orgzly.com/docs#links]] 참고하세요.
...
자세한 내용은 "https://www.orgzly.com/docs#search" 참고하세요.
