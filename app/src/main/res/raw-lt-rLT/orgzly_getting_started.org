...
Skambinkite tel. numeriu (tel:370-000), siųsti SMS (sms:370-000), rašyti el. laišką (mailto:support@orgzly.com) ar apsilankyti svetainėje ([[https://orgzly.alensiljak.cc][Orgzly II]).

Taip pat galite nurodyti į kitą įrašą ar užrašinę programėlėje.

Žiūrėkite [[https://orgzly.alensiljak.cc/docs#links]] išsamesnei informacijai.
...
Žiūrėkite [[https://orgzly.alensiljak.cc/docs#search]] išsamesnei informacijai.
