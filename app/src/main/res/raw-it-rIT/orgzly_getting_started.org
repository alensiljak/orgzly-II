...
Digita un numero di telefono (tel:555-0199), invia SMS (sms:555-0199), componi un'email (mailto:support@orgzly.com) o visita una pagina web ([[https://orgzly.alensiljak.cc][Orgzly II]).

Puoi anche collegarti a un'altra nota o a un taccuino all'interno dell'app.

Vai su https://orgzly.alensiljak.cc/docs#links per maggiori informazioni.
...
Vai su [[https://orgzly.alensiljak.cc/docs#search]] per saperne di più.
