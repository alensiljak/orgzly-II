#+BEGIN_HTML
<div>
<a title="Tests" target="_blank" href="https://github.com/alensiljak/orgzly-II/actions/workflows/test.yaml"><img src="https://github.com/orgzly/orgzly-II/actions/workflows/test.yaml/badge.svg"></a>
<a href="https://toolate.othing.xyz/engage/orgzly/"><img src="https://toolate.othing.xyz/widget/orgzly/svg-badge.svg" alt="Translation status" /></a>
<a href="https://shields.rbtlog.dev/com.orgzly"><img src="https://shields.rbtlog.dev/simple/com.orgzly" alt="RB Status"></a>
</div>
#+END_HTML

* Orgzly

Orgzly is an outliner for taking notes and managing to-do lists. Orgzly is a community-maintained version of Orgzly, as the development of the original app has been halted. The original Orgzly source code can be found
...
#+BEGIN_HTML
<a href="https://f-droid.org/packages/com.orgzly">
...
<a href="https://apt.izzysoft.de/packages/com.orgzly">
<img src="https://gitlab.com/IzzyOnDroid/repo/-/raw/master/assets/IzzyOnDroid.png" alt="Get it on IzzyOnDroid" height="80">
</a>
#+END_HTML

The Orgzly project aims to continue development of the Orgzly application. The rebranding is due to the disappearance of the Orgzly author so we, as the community, had to come up with a new solution. We plan to continue adding useful features, fixing bugs, keeping up-to-date with technological evolution, and generally maintaining the [[https://orgmode.org/][Org Mode]] outreach and its support on Android. Orgzly  is a community-maintained version of Orgzly, as the development of the original app is no longer active.

* Support

- See the detailed [[https://github.com/orgzly/documentation][End-user documentation]]
- Ask your question in the [[https://github.com/orgzly/orgzly/discussions][Discussions]]
...
#+begin_quote
com.orgzly 6F:C9:C2:E2:2D:07:D2:5C:E7:7E:2E:96:34:55:05:3C:38:B8:31:8A:1A:24:91:B3:ED:95:D5:0C:BA:85:49:3D
#+end_quote

You should also check that this checksum matches the one published at [[https://orgzly.com/docs#verify-apk-signature][orgzly.com]].
...
Translations can be contributed on the [[https://toolate.othing.xyz/projects/orgzly/][Toolate]] i18n platform.
